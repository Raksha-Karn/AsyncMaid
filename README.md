...
A lightweight but fully-featured async task runner. It accepts jobs through a clean REST API, queues them via Celery + Redis, processes them asynchronously, and stores results in a PostgreSQL database.  
